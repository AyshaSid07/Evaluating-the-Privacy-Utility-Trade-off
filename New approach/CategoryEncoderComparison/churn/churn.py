...
# Then the rest of the steps is taken from data/churn.py
# ID 41283 corresponds to the churn dataset on openML
dataset = fetch_openml(data_id=41283, as_frame=True, parser='auto')
