...
# Then the rest of the steps is taken from data/cholesterol.py
# ID 204 corresponds to the cholesterol dataset on openML
dataset = fetch_openml(data_id=204, as_frame=True, parser='auto')

# Extract the Pandas DataFrame
df = dataset.frame

df.to_csv("cholesterol.csv", index=False)
