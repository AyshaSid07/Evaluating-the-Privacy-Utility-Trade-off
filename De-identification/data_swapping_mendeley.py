...
quasi_identifiers_to_swap = ["City", "Region", "Country"] # we can choose which quasi-identifiers to swap
...
df.to_csv("../datasets/de_identified_datasets/swapped_dataset_mendeley.csv", index=False)