...
def plot_results(results_df):
    ...
    plt.tight_layout()
    plt.savefig("../plots/attribute_inference_credit_card_clients.png", dpi=300)
    plt.show()
...
datasets_to_test = {
    ...
    # "ARX Credit Card Clients, k = 5, t = 0.05": pd.read_csv('../datasets/ARX_credit_card_clients_k=5_t=0.05.csv'),    
    # "No anonymization (Baseline)": pd.read_csv('../datasets/credit-card-clients.csv'),
    # "Anjana Credit Card Clients, k = 5": pd.read_csv('../datasets/credit_card_k=5.csv'),
    # "Anjana Credit Card Clients, k = 5, l = 2": pd.read_csv('../datasets/credit_card_k=5_l=2.csv'),
    # "Anjana Credit Card Clients, k = 5, l = 3": pd.read_csv('../datasets/credit_card_k=5_l=3.csv'),
    # "Anjana Credit Card Clients, k = 5, t = 0.10": pd.read_csv('../datasets/credit_card_k=5_t=0.1.csv'),
    # "Anjana Credit Card Clients, k = 5, t = 0.05": pd.read_csv('../datasets/credit_card_k=5_t=0.05.csv'),
}
