...
print(f"Accuracy:  {accuracy_score(y_test, y_predicts):.4f}")
print(f"F1 score:  {f1_score(y_test, y_predicts):.4f}")
print(f"Precision: {precision_score(y_test, y_predicts):.4f}")
print(f"Recall:    {recall_score(y_test, y_predicts):.4f}")
