...
for epsilon in epsilons:
    ...
    out_path = f"{OUTPUT_DIR}public_coverage_dp_epsilon_{str(epsilon).replace('.', '_')}.csv"
...
for epsilon in epsilons:
    print(f"  epsilon={epsilon} -> public_coverage_dp_epsilon_{str(epsilon).replace('.', '_')}.csv")