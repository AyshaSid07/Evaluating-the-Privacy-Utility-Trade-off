...
def plot_results(results_df):
    ...
    plt.title('Attribute Inference Attack Results on different anonymization values on the ACS Public Coverage Data', fontsize=10)

    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
    plt.savefig("../plots/attribute_inference_public_coverage.png", dpi=300)
    plt.show()
