...
def plot_results(results_dict):
    ...
    # plt.ylim(0, 1)
    plt.tight_layout()
    # plt.savefig("../plots/dcr_mean_distance_acs_income_DP.png", dpi=300)
    plt.savefig("../plots/dcr_mean_distance_acs_income_ARX_k_only.png", dpi=300)
    # plt.savefig("../plots/dcr_mean_distance_acs_income_ARX_k_l_t.png", dpi=300)
    plt.show()
...
csv_filepath = "../plots/dcr/dcr_results_acs_income.csv" 
