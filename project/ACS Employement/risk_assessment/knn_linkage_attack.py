...
if __name__ == "__main__":
    ...
    quasi_identifiers = ["AGEP", "SCHL", "MAR", "RELP", "ESP", "CIT", "NATIVITY", "RAC1P"]
    ...
    "anjana employment k = 10": pd.read_csv('../datasets/anjana_employment_mar_k=10.csv'),
    "anjana employment k = 20": pd.read_csv('../datasets/anjana_employment_mar_k=10.csv'),
    "anjana employment k = 50": pd.read_csv('../datasets/anjana_employment_mar_k=10.csv'),
    }
