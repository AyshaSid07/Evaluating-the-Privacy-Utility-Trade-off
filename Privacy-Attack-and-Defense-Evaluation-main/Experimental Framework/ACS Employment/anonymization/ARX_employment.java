...
public class ARX_employment {
    public static void main(String[] args) throws Exception {
        // path of the original employment dataset
        String inputPath = "../datasets/folktables_employment_RAW.csv";
        String outputBasePath = "../datasets/ARX_acs_employment_"; 
        ...
        String[] qis = {"AGEP", "SCHL", "SEX", "MAR", "RELP", "ESP", "CIT", "MIG", "MIL", "ANC", "NATIVITY"};
