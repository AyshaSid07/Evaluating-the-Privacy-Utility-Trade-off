...
# IMPORTANT: Verify these are the correct continuous columns for your ACS Public Coverage setup
...
df_train_real = pd.read_csv("../datasets/folktables_public_coverage_train.csv", low_memory=False)
df_test_real = pd.read_csv("../datasets/folktables_public_coverage_test.csv", low_memory=False)
...
# ==============================
# Updated paths to use _cleaned.csv per Elad's requirement
protected_datasets = {
...
for seed in seeds:
    ...
    for name, df_protected_original in datasets_to_test.items():
        ...
        pd.DataFrame(all_results).to_csv("../results/utility/acs_public_coverage_utility_results_all_runs_partial.csv", index=False)

# ==============================
# Save all results and mean/std summary
# ==============================
results_df = pd.DataFrame(all_results)
results_df.to_csv("../results/utility/acs_public_coverage_utility_results_all_runs.csv", index=False)
...
summary_df.to_csv("../results/utility/acs_public_coverage_utility_results_summary.csv", index=False)
