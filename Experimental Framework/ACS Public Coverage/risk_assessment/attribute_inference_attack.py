...
df_train_real_raw = pd.read_csv('../datasets/folktables_public_coverage_train.csv', low_memory=False)
df_test_real_raw = pd.read_csv('../datasets/folktables_public_coverage_test.csv', low_memory=False)
...
for seed in seeds:
    ...
    for name, df_adv_original in datasets_to_test.items():
        ...
        pd.DataFrame(all_results).to_csv("../results/aia/public_coverage_aia_results_all_runs_partial.csv", index=False)
pd.DataFrame(ablation_results).to_csv("../results/aia/public_coverage_aia_rac1p_ablation.csv", index=False)
results_df = pd.DataFrame(all_results)
results_df.to_csv("../results/aia/public_coverage_aia_results_all_runs.csv", index=False)
summary_df = (
    results_df
...
summary_df.to_csv("../results/aia/public_coverage_aia_results_summary.csv", index=False)
