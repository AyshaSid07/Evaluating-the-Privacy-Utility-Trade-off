...
if __name__ == "__main__":
    ...
    quasi_identifiers = ["AGEP", "SCHL", "SEX", "MAR", "ESP", "CIT", "MIG", "MIL", "ANC", "NATIVITY", "ESR"]
    ...
    for defense_name, df_protected in datasets_to_test.items():
        ...
        attacker_indices = df_protected['Linkage_Index'].sample(n=1385, random_state=123)
    ...
    df_results.to_csv("../results/linkage/linkage_attack_results_acs_public_coverage.csv", index=False)
