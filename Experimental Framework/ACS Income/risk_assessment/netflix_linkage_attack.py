...
n_attacker_records = 1950 # 1% of the dataset size
...
if __name__ == "__main__":
    df_original = pd.read_csv('../datasets/folktables_income_train.csv')
    ...
    for run_id, seed in enumerate(seeds, start=1):
        ...
        pd.DataFrame(all_summaries).to_csv(
            "../results/linkage/linkage_attack_results_income_all_runs_partial.csv",
            index=False
        )

    results_df = pd.DataFrame(all_summaries)
    results_df.to_csv("../results/linkage/linkage_attack_results_income_all_runs.csv", index=False)
    ...
    summary_df.to_csv("../results/linkage/linkage_attack_results_income_summary.csv", index=False)
