...
# Numeric columns based on the ACS Income feature space
...
df_train_real = pd.read_csv("../datasets/folktables_income_train.csv", low_memory=False)
df_test_real = pd.read_csv("../datasets/folktables_income_test.csv", low_memory=False)
...
# ==============================
# Updated paths to use _cleaned.csv to drop fully suppressed ARX rows
protected_datasets = {
...
for seed in seeds:
    ...
    for name, df_protected_original in datasets_to_test.items():
        ...
        pd.DataFrame(all_results).to_csv("../results/utility/acs_income_utility_results_all_runs_partial.csv", index=False)

# ==============================
# Save all results and mean/std summary
# ==============================
results_df = pd.DataFrame(all_results)
results_df.to_csv("../results/utility/acs_income_utility_results_all_runs.csv", index=False)
...
summary_df.to_csv("../results/utility/acs_income_utility_results_summary.csv", index=False)
