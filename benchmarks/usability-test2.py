...
def plot_utility_results(results_dict, target_col):
    ...
    plt.title(f'Usability test 2 of different de-identification methods for target column: {target_col}', fontsize=12)
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    
    plt.tight_layout()
    plt.savefig("plots/utility_plot2.png", dpi=300)
