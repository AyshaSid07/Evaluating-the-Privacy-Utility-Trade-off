...
def perform_attack(df_protected, df_attacker, quasi_identifiers, defense_name):    
...
def plot_results(results_dict):
    ...
    plt.title('Fellegi-Sunter Attack Re-identification Rate Across De-identified Datasets on the "IP Address Geographic Profiles" Dataset', fontsize=10)
